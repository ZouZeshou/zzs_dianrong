...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_senser = 0;
		//ANO_DT_Send_Senser(0, 0, 0, 0, yaw.chas_spd, yaw.BackAngleSpd, 0, 0, 0, 0);
	}	
/////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_pid1 = 0;
//		ANO_DT_Send_PID(1,YawIMUPID_Outer.kp, YawIMUPID_Outer.ki, YawIMUPID_Outer.kd, \
//											YawIMUPID_Inner.kp, YawIMUPID_Inner.ki, YawIMUPID_Inner.kd, \
//											0, 0, 0);
	}	
/////////////////////////////////////////////////////////////////////////////////////
	else if(f.send_pid2)
...
{
	HAL_UART_Transmit(&huart2, data_to_send, length, 20);
}
...
void ANO_DT_Send_Senser(float a_x,float a_y,float a_z,int16_t g_x,int16_t g_y,int16_t g_z,int16_t m_x,int16_t m_y,int16_t m_z,int32_t bar)
{
	uint8_t _cnt=0;
